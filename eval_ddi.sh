...
python eval_wc.py --load_arg ./checkpoint/drugddi2011_we_2_cwlm_lstm_crf.json --load_check_point ./checkpoint/drugddi2011_we_2_cwlm_lstm_crf.model --gpu -1 --dev_file ../data/drugddi2011/val.ddi --test_file ../data/drugddi2011/test.ddi
