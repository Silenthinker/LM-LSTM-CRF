python seq_wc.py --load_arg ./checkpoint/drugddi2011_we_1_cwlm_lstm_crf.json --load_check_point ./checkpoint/drugddi2011_we_1_cwlm_lstm_crf.model --gpu -1 --input_file ../data/drugddi2011/test.ddi --output_file ../data/drugddi2011/pred.ddi -keep_iobes
